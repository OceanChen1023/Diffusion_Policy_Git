...
class RealPushTImageDataset(BaseImageDataset):
    def __init__(self,
        ...
        if delta_action:
            ...
            print("episode_ends_length: ", len(episode_ends))
    ...
    def __getitem__(self, idx: int) -> Dict[str, torch.Tensor]:
        #caller = inspect.stack()[1]  # [1] 代表上一層呼叫者
        #print(f"__getitem__ called from function: {caller.function} in file: {caller.filename}, line {caller.lineno}")
        ...
        T_slice = slice(self.n_obs_steps)   #n_obs_steps=2
        ...
        for key in self.rgb_keys:
            ...
            # print("rgb_key:",key,",obs_dict",obs_dict[key].shape)
            # T,C,H,W
            # save ram
            del data[key]
        for key in self.lowdim_keys:
